...
<div class="main-content">
    <section class="buscar-container">
        ...
        <div class="buscar-bar">
            ...
            <div class="select">
                <select class="select-marca" id="id_proyecto" name="id_proyecto" required onchange="loadForm(1)">
...
function loadForm(page) {
    ...
    xhr.open("POST", "<?php echo APP_URL; ?>app/controller/cargar_historialGerente.php", true);
